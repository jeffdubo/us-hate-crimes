...
SELECT COUNT(DISTINCT(incident.incident_id)) AS Total FROM incident; -- 81666
SELECT COUNT(DISTINCT(incident_view.incident_id)) AS Total FROM incident_view; -- 81666